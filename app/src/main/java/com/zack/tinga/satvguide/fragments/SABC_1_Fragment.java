...
import com.zack.tinga.satvguide.adapter.TvAdapter;
...
public class SABC_1_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        mDatabaseReference = FirebaseDatabase.getInstance().getReference("sabc1");
            ...
            protected void populateViewHolder(tvShowsAdapter viewHolder, TVClass model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        final ImageView imgv_image = (ImageView) mView.findViewById(R.id.imgv_image);
                        final TextView textViewShowName = (TextView) mView.findViewById(R.id.textViewShowName);
                        ...
                        mDatabaseReference.child(key).addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                ...
                                Picasso.with(context).load(img).into(imgv_image);
                            }
